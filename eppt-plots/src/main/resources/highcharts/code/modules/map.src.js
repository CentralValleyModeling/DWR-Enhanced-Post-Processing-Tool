...
(function (factory) {
    ...
    _registerModule(_modules, 'parts-map/MapNavigation.js', [_modules['parts/Globals.js']], function (H) {
        /* *
         *
         *  (c) 2010-2019 Torstein Honsi
         *
    ...
    _registerModule(_modules, 'parts-map/MapSeries.js', [_modules['parts/Globals.js']], function (H) {
        /* *
         *
         *  (c) 2010-2019 Torstein Honsi
         *
