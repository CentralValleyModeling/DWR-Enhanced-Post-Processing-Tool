...
const { toFileUrl } = require("jsdom/lib/jsdom/utils");
const documentFeatures = require("jsdom/lib/jsdom/browser/documentfeatures");
...
require("jsdom/lib/jsdom/living"); // Enable living standard features
