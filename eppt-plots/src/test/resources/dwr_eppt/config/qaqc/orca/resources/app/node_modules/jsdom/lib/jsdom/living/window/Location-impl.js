...
const { documentBaseURL, parseURLToResultingURLRecord } = require("jsdom/lib/jsdom/living/helpers/document-base-url");
const { navigate } = require("jsdom/lib/jsdom/living/window/navigation");
