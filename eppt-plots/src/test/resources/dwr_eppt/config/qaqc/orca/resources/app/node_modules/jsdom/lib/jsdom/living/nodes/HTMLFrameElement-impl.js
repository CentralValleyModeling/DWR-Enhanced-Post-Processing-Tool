...
const { evaluateJavaScriptURL } = require("jsdom/lib/jsdom/living/window/navigation");
...
const { defineGetter, reflectURLAttribute } = require("jsdom/lib/jsdom/utils");
const { documentBaseURL } = require("jsdom/lib/jsdom/living/helpers/document-base-url");
const { getAttributeValue } = require("jsdom/lib/jsdom/living/attributes");
