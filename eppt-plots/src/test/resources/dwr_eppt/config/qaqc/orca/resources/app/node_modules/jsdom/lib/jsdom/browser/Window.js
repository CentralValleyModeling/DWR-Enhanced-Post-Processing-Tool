...
const namedPropertiesWindow = require("jsdom/lib/jsdom/living/named-properties-window");
...
const createXMLHttpRequest = require("jsdom/lib/jsdom/living/xmlhttprequest");
const createFileReader = require("jsdom/lib/jsdom/living/generated/FileReader").createInterface;
const createWebSocket = require("jsdom/lib/jsdom/living/generated/WebSocket").createInterface;
const WebSocketImpl = require("jsdom/lib/jsdom/living/websockets/WebSocket-impl").implementation;
const BarProp = require("jsdom/lib/jsdom/living/generated/BarProp");
const Document = require("jsdom/lib/jsdom/living/generated/Document");
const External = require("jsdom/lib/jsdom/living/generated/External");
const Navigator = require("jsdom/lib/jsdom/living/generated/Navigator");
const Performance = require("jsdom/lib/jsdom/living/generated/Performance");
const Screen = require("jsdom/lib/jsdom/living/generated/Screen");
const Storage = require("jsdom/lib/jsdom/living/generated/Storage");
const createAbortController = require("jsdom/lib/jsdom/living/generated/AbortController").createInterface;
const createAbortSignal = require("jsdom/lib/jsdom/living/generated/AbortSignal").createInterface;
const reportException = require("jsdom/lib/jsdom/living/helpers/runtime-script-errors");
const { matchesDontThrow } = require("jsdom/lib/jsdom/living/helpers/selectors");
const SessionHistory = require("jsdom/lib/jsdom/living/window/SessionHistory");
const { contextifyWindow } = require("jsdom/lib/jsdom/browser/documentfeatures.js");
