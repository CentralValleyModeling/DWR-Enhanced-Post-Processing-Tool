...
;(function (global, factory) {
    ...
    RowManager.prototype.filterRefresh = function () {
        ...
        if (options.ajaxFiltering) {
            ...
            if (options.pagination == "remote" && table.modExists("page")) {
                ...
                table.modules.page.setPage(1).then(function () {
                }).catch(function () {
                });
            } else if (options.ajaxProgressiveLoad) {

                table.modules.ajax.loadData().then(function () {
                }).catch(function () {
                });
            } else {
    ...
    Row.prototype.delete = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (_this7.table.options.history && _this7.table.modExists("history")) {
                ...
                _this7.table.modules.history.action("rowDelete", _this7, {
                    data: _this7.getData(),
                    pos: !index,
                    index: index
                });
            ...
            if (self.options.pagination == "local") {
                ...
                if (self.options.data.length) {
                    ...
                    if ((self.options.ajaxURL || self.options.ajaxURLGenerator) && self.modExists("ajax")) {
                        ...
                        self.modules.ajax.loadData().then(function () {
                        }).catch(function () {
                        });
                    } else {
                ...
                if (self.options.ajaxURL) {
                    ...
                    self.modules.page.setPage(1).then(function () {
                    }).catch(function () {
                    });
                } else {
    ...
    Clipboard.prototype.generateHTML = function (rows, columns, calcs, config, params) {
		...
		function processColumn(column, rowData, rowEl) {

			if(column.subGroups){
				column.subGroups.forEach(function(c){
					processColumn(c, rowData, rowEl);
				});
			}
			else if(column.subGroups){
		...
		function processRows(rowArray) {
            ...
            rowArray.forEach(function (row, i) {
                ...
                columns.forEach(function(column){
					processColumn(column, rowData, rowEl);
				});
