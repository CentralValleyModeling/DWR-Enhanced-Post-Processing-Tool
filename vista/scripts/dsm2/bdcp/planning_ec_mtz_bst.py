...
def planning_ec_mtz():  # MTZ = RSAC054 BC for the qual
    ...
    for twstr in blocks:
        ...
        mtzastro = DataReference.create(
            findpath(PLANNINGTIDE, "/FILL\+CHAN/RSAC054/STAGE//15MIN/" + astro_stage_version + "/")[0],
            TWINDBUF).getData()
        ...
        if DEBUG:
            ...
            [mtzecest_no_vamp, g1_no_vamp] = ec_boundary.ECEst(mtzastro, fifteenflo2_no_vamp, beta=600, npow1=0.75,
                                                               npow2=1, g0=g0_no_vamp, zrms=astrorms)
