...
from java.awt import FileDialog, Cursor
from java.awt.event import MouseAdapter, KeyEvent
from java.util import Properties
# java help stuff
from javax.help import CSH, HelpSet
from javax.swing import JFrame, JTable, JScrollPane, JMenuItem, JMenu, JMenuBar, JOptionPane, ImageIcon, JSplitPane, \
    JTextArea, SwingConstants
...
class OptionsDialog(JDialog):
    def __init__(self, gd):
        ...
        ppanel = JPanel();
        ppanel.setLayout(BorderLayout());
        ppanel.add(self.pfield)
        ...
        text_panel = JPanel();
        text_panel.setLayout(GridLayout(2, 3))
        text_panel.add(tp5);
        text_panel.add(tp4);
        text_panel.add(tp1)
        text_panel.add(tp2);
        ...
        print_panel.add(ppanel);
        print_panel.add(self.lchoice)
        ...
        attr_panel.add(eattr);
        attr_panel.add(gattrBtn)
...
class GraphGui(JPanel):
    def __init__(self, gd=GraphData("")):
        ...
        tp = JPanel();
        tp.setLayout(BorderLayout())
        tp.add(self.title_field);
        tp.setBorder(BorderFactory.createTitledBorder("Graph Title"))
        rc_panel = JPanel()
        rp = JPanel();
        rp.add(self.row_field)
        rp.add(self.row_field);
        rp.setBorder(BorderFactory.createTitledBorder("# of rows"))
        cp = JPanel();
        cp.add(self.col_field)
        cp.add(self.col_field);
        cp.setBorder(BorderFactory.createTitledBorder("# of columns"))
        ...
        self.main_panel.setLayout(GridLayout(4, 1))
        ...
        self.study_panel = JPanel();
        self.study_panel.setLayout(BorderLayout())
...
class PlotGui(JPanel, TreeSelectionListener):
    def __init__(self, pd=PlotData(None)):
        ...
        ap = JPanel();
        ap.setLayout(BorderLayout());
        ap.add(self.axis_field)
        ap.setBorder(BorderFactory.createTitledBorder("Y Axis Label"))
        rwp = JPanel();
        rwp.setLayout(BorderLayout());
        rwp.add(self.range_field)
        ...
        twp = JPanel();
        twp.setLayout(BorderLayout());
        twp.add(self.tw_field)
        twp.setBorder(BorderFactory.createTitledBorder("Time Window"))
        oppanel1 = JPanel();
        oppanel1.setLayout(GridLayout(4, 2))
        oppanel1.add(tp)
        oppanel1.add(ap)
        oppanel1.add(rwp)
        oppanel1.add(twp)
        ...
        lfpp = JPanel();
        lfpp.setLayout(BorderLayout());
        lfpp.add(self.lfp)
        lfpp.setBorder(BorderFactory.createTitledBorder('Left footer'))
        rfpp = JPanel();
        rfpp.setLayout(BorderLayout());
        rfpp.add(self.rfp)
        rfpp.setBorder(BorderFactory.createTitledBorder('Right footer'))
        cfpp = JPanel();
        cfpp.setLayout(BorderLayout());
        cfpp.add(self.cfp)
        cfpp.setBorder(BorderFactory.createTitledBorder('Center footer'))
        footer_panel = JPanel();
        footer_panel.setLayout(GridLayout(1, 3))
        footer_panel.add(lfpp);
        footer_panel.add(cfpp);
        footer_panel.add(rfpp)
        #
        ...
        oppanel3 = JPanel();
        oppanel3.setLayout(BorderLayout())
        ...
        #
        tpanel1 = JPanel();
        tpanel1.setLayout(BorderLayout())
        tpanel1.add(jsp);
        tpanel1.add(self.getMenuBar(), BorderLayout.NORTH)
        ...
        #
        tpanel2 = JPanel();
        tpanel2.setLayout(BorderLayout())
        tpanel2.add(jsp2);
        tpanel2.add(self.getEMenuBar(), BorderLayout.NORTH)
        ...
        #
        tpanel = JPanel();
        tpanel.setLayout(GridLayout(4, 1))
        tpanel.add(tpanel4)
        tpanel.add(tpanel1)
        tpanel.add(tpanel3)
        tpanel.add(tpanel2)
        ...
        #
        oppanel = JPanel();
        oppanel.setLayout(GridLayout(3, 1))
