...
var shorthand_for = {
    'border-width': require('cssstyle/lib/properties/borderWidth'),
    'border-style': require('cssstyle/lib/properties/borderStyle'),
    'border-color': require('cssstyle/lib/properties/borderColor')
};
