 ...
 * @since 01-10-2020
 */
public class ExceedanceChartPaneScaffold
{
	public final void initScaffold() throws EpptInitializationException
	{
		...
		MonthExceedancePane marchPanel = new MonthExceedancePane(Month.MARCH, guiLink, Arrays.asList(baseRun, altRun, altRun2, altRun3, altRun4),
		...
		AllExceedancePane allPanel = new AllExceedancePane(guiLink, Arrays.asList(baseRun, altRun, altRun2, altRun3, altRun4),
				...
				LocalDate.of(1921, 1, 1), LocalDate.of(1999, 1, 1), true);
		tabbedPane.addTab("March", marchPanel);
		tabbedPane.addTab("Annual", annualPanel);
	...
	{
		new ExceedanceChartPaneScaffold().initScaffold();
	}
