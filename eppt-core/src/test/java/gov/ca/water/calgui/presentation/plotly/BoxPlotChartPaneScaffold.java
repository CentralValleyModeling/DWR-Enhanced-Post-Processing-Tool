 ...
 * @since 01-10-2020
 */
public class BoxPlotChartPaneScaffold
{
	public final void initScaffold() throws EpptInitializationException
		{
			...
			BoxPlotChartPane epptPanel = new BoxPlotChartPane(guiLink, Arrays.asList(baseRun, altRun, altRun2, altRun3, altRun4),
		...
		{
			new BoxPlotChartPaneScaffold().initScaffold();
		}
