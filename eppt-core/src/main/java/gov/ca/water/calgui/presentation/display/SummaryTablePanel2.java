...
/**
 * Variant of SummaryTablePanel that handles MTS results
 *
 * @author tslawecki
 */
public class SummaryTablePanel2 extends JPanel implements ActionListener, ComponentListener
{
						...
						for(int i2 = 0; i2 < 6; i2++)
						{
...

							{
								if((((i1 == 0) && tagString.contains("All years") && (i2 == 0))
										...
										|| ((i1 == 5) && (i2 == 3) && tagString.contains("1992")))
										&& (n[i1][i2][i3] > 0))
								{

									avg[i1][i2][i3] = _x[i1][i2][i3] / n[i1][i2][i3];
