...
public class TrendParameter
{
	...
	TrendParameter(int index, Integer guiLinkId, String titleOverride)
	{
		_editable = false;
		_index = index;
	...
	private TrendParameter(int index, GUILinksAllModelsBO guiLink)
	{
		_editable = true;
		_index = index;
		_guiLink = guiLink;
	...
	public static TrendParameter create(int index, GUILinksAllModelsBO guiLink)
	{
		return new TrendParameter(index, guiLink);
	}
