...
public class AnnualExceedancePane extends JFXPanel
{
								...
								PlotConfigurationState.ComparisonType comparisonType, LocalDate start, LocalDate end, boolean taf)
	{
		...
		Platform.runLater(() ->
		{
			_javaFxChartsPane = new JavaFxChartsPane(Paths.get(Constant.CONFIG_DIR).resolve("plots").resolve("exceedance_annual.htm"),
