...
public class TestMassBalanceRow
{
    ...
    @Test
    void testWritingAndReadingMassBalanceRowElementWithNoAlternative() throws Exception
    {
        ...
        List<MassBalance> massBals = new ArrayList<>();
        massBals.add(new MassBalance(incidents));

        ExecutiveReport er = new ExecutiveReport(createERHeader(), mis, resOps, mifs, nods,
                new ArrayList<>(),new ArrayList<>(),new ArrayList<>(),allDels,massBals);
        ...
        List<Element> elemsToTest = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.MASS_BALANCE);
        List<Element> elemsFromMaster = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.MASS_BALANCE);
    ...
    @Test
    void testWritingAndReadingMassBalanceRowElementWith1Alternative() throws Exception
    {
        String path = System.getProperty("user.dir");
        String filePath = path + "\\executivereport.xml";
        ...
        List<MassBalance> massBals = new ArrayList<>();
        massBals.add(new MassBalance(incidents));
        massBals.add(new MassBalance(incidents2));
        ...
        List<Element> modelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.MASS_BALANCE);
        List<Element> masterModelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.MASS_BALANCE);
