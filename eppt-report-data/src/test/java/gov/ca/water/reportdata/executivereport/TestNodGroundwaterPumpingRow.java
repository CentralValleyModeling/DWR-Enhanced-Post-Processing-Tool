...
public class TestNodGroundwaterPumpingRow
{
    ...
    @Test
    void testWritingAndReadingNodWeirRowElementWithNoAlternative() throws Exception
    {
        ...
        List<NodGroundwaterPumping> ngp = new ArrayList<>();
        NodGroundwaterPumping basengp = new NodGroundwaterPumping(incidents);
        ngp.add(basengp);

        ExecutiveReport er = new ExecutiveReport(createERHeader(), mis, resOps, mifs, nods, ngp,
        ...
        List<Element> elemsToTest = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.NOD_GROUND_PUMP);
        List<Element> elemsFromMaster = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.NOD_GROUND_PUMP);
    ...
    @Test
    void testWritingAndReadingNodWeirRowElementWith1Alternative() throws Exception
    {
        String path = System.getProperty("user.dir");
        String filePath = path + "\\executivereport.xml";
        ...
        List<NodGroundwaterPumping> ngp = new ArrayList<>();
        NodGroundwaterPumping basengp = new NodGroundwaterPumping(incidents);
        NodGroundwaterPumping altngp = new NodGroundwaterPumping(incidents2);
        ngp.add(basengp);
        ngp.add(altngp);
        ...
        List<Element> modelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.NOD_GROUND_PUMP);
        List<Element> masterModelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.NOD_GROUND_PUMP);
