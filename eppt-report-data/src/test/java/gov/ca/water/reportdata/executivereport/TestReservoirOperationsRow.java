...
public class TestReservoirOperationsRow
{
    ...
    void testWritingAndReadingReservoirOperationsRowElementWithNoAlternative() throws Exception
    {
        ...
        ReservoirOperation baseResOp = new ReservoirOperation(below, above, spill);
        resOps.add( baseResOp);

        ExecutiveReport er = new ExecutiveReport(createERHeader(), mis, resOps, new ArrayList<>(), new ArrayList<>(),
        ...
        List<Element> elemsToTest = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.RES_OPS);
        List<Element> elemsFromMaster = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.RES_OPS);
    ...
    void testWritingAndReadingReservoirOperationsRowElementWith1Alternative() throws Exception
    {
        ...
        List<ReservoirOperation> resOps = new ArrayList<>();
        resOps.add( new ReservoirOperation(below, above, spill));
        resOps.add(new ReservoirOperation(below2, above2, spill2));
        ...
        List<Element> modelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.RES_OPS);
        List<Element> masterModelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.RES_OPS);
