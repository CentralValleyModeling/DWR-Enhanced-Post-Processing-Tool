...
public class TestDeltaOpsRow
{
    ...
    @Test
    void testWritingAndReadingDeltaOpsRowElementWithNoAlternative() throws Exception
    {
        ...
        List<DeltaOperation> deltaOps = new ArrayList<>();
        deltaOps.add(new DeltaOperation(incidents));
        ...
        List<Element> elemsToTest = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.DELTA_OPS);
        List<Element> elemsFromMaster = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.DELTA_OPS);
    ...
    @Test
    void testWritingAndReadingDeltaOpsRowElementWith1Alternative() throws Exception
    {
        String path = System.getProperty("user.dir");
        String filePath = path + "\\executivereport.xml";
        ...
        List<DeltaOperation> deltaOps = new ArrayList<>();
        deltaOps.add(new DeltaOperation(incidents));
        deltaOps.add(new DeltaOperation(incidents2));
        ...
        List<Element> modelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.DELTA_OPS);
        List<Element> masterModelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.DELTA_OPS);
