...
public class TestCOARow
{
    ...
    void testWritingAndReadingDeltaOpsRowElementWithNoAlternative() throws Exception
    {
        ...
        List<Element> elemsToTest = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.COA);
        List<Element> elemsFromMaster = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.COA);
    ...
    void testWritingAndReadingDeltaOpsRowElementWith1Alternative() throws Exception
    {
        ...
        List<Element> modelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.COA);
        List<Element> masterModelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.COA);
