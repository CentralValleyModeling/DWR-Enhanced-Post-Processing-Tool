...
public class TestNodWeirRow
{
    ...
    void testWritingAndReadingNodWeirRowElementWithNoAlternative() throws Exception
    {
        ...
        NodWeirsOperations baseNod = new NodWeirsOperations(incidents);
        nods.add(baseNod);
        ...
        List<Element> elemsToTest = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.NOD_WEIR);
        List<Element> elemsFromMaster = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.NOD_WEIR);
    ...
    void testWritingAndReadingNodWeirRowElementWith1Alternative() throws Exception
    {
        ...
        NodWeirsOperations baseNod = new NodWeirsOperations(incidents);
        nods.add(baseNod);
        nods.add(new NodWeirsOperations(incidents2));
        ...
        List<Element> modelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCReportToTest, ExecutiveReportXMLWriter.NOD_WEIR);
        List<Element> masterModelInputElems = ExecutiveReportTestUtilities.getModuleElementsWithName(_qAQCMaster, ExecutiveReportXMLWriter.NOD_WEIR);
