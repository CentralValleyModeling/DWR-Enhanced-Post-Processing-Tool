...
template = r'C:\Users\bryan\JaspersoftWorkspace\MyReports\DWR_QA_QC_Reports\Subreports\summary_templates\QAQC_exceedance_page.jrxml' #full path to template file. Keep the r in front
new_directory = r'C:\Users\bryan\JaspersoftWorkspace\MyReports\DWR_QA_QC_Reports\Subreports\exceedance-page'
column_d_type = 'exceedance-page'
