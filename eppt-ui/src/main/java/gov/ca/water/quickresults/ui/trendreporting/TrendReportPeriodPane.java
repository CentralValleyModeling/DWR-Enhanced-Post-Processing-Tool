 ...
 * @since 01-02-2020
 */
public class TrendReportPeriodPane extends TitledPane
{
	...
	public void addListener(ChangeListener<? super MonthPeriod> inputsChanged)
	{
	...
	public ObservableList<MonthPeriod> getSelectedItems()
	{
