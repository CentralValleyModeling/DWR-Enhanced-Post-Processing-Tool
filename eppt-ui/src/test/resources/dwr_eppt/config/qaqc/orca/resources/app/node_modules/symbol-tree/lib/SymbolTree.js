...
const SymbolTreeNode = require('symbol-tree/lib/SymbolTreeNode');
const TreePosition = require('symbol-tree/lib/TreePosition');
const TreeIterator = require('symbol-tree/lib/TreeIterator');
