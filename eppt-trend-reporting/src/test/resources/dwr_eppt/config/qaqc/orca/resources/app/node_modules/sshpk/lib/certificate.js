...
var Identity = require('sshpk/lib/identity');

var formats = {};
formats['openssh'] = require('sshpk/lib/formats/openssh-cert');
formats['x509'] = require('sshpk/lib/formats/x509');
formats['pem'] = require('sshpk/lib/formats/x509-pem');
