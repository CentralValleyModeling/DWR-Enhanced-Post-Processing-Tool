...
const { cloningSteps, domSymbolTree } = require("jsdom/lib/jsdom/living/helpers/internal-constants");
const NODE_TYPE = require("jsdom/lib/jsdom/living/node-type");
const orderedSetParse = require("jsdom/lib/jsdom/living/helpers/ordered-set").parse;
const { asciiCaseInsensitiveMatch, asciiLowercase } = require("jsdom/lib/jsdom/living/helpers/strings");
const { HTML_NS, XMLNS_NS } = require("jsdom/lib/jsdom/living/helpers/namespaces");
