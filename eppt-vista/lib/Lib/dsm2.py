...
from javax.swing import JTree, JScrollPane
from javax.swing import JFrame, JRadioButton
...
class DSM2Parser:
    ...
    def parse_channels(self, fh):
        headers = ['chan', 'length', 'manning', 'disp', 'downnode', 'upnode', 'xsect1', 'dist1', 'xsect2', 'dist2',
                   'xsect3', 'dist3', 'xsect4', 'dist4']
