...
:run2
"%vista_home%/jre8/bin/java" -mx256m  -Djava.library.path=%LPATH% -Dvista.home="%vista_home%" -Dpython.home=%PYHOME% -Dpython.path=%PYPATH% -Dpython.console=org.python.util.InteractiveConsole -classpath %CPATH% org.python.util.jython -i  %ARGS%
