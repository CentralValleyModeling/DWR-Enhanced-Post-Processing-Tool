 ...
 *
 * @author Nicky Sandhu
 * @version $Id: InstValFlaggedCurveModel.java,v 1.1 2003/10/02 20:48:33 redwood
 * Exp $
 */
public class InstValFlaggedCurveModel implements CurveDataModel
{
	private DataSet _ds;
	...
	private boolean _lastQR;
	private Object _obj;

	/**
	 *
	 */
	public InstValFlaggedCurveModel(DataSet ds, ElementFilter f,
	 ...
	 *
	 */
	public InstValFlaggedCurveModel(DataSet ds, ElementFilter f, int xap,
									int yap)
	{
