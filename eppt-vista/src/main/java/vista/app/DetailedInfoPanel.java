...
public class DetailedInfoPanel extends JPanel
{
	public DetailedInfoPanel(DataReference ref)
	{
		...
		add(new JLabel("Record Type"));
		add(new JLabel("" + recType));
		add(new JLabel("Data Offset"));
		add(new JLabel("" + data._offset));
		add(new JLabel("Number Read"));
		add(new JLabel("" + data._numberRead));
		add(new JLabel("X Type"));
		add(new JLabel("" + data._xType));
		add(new JLabel("Y Type"));
		add(new JLabel("" + data._yType));
		add(new JLabel("X Units"));
		add(new JLabel("" + data._xUnits));
		add(new JLabel("Y Units"));
		add(new JLabel("" + data._yUnits));
	}
}
